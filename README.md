...
- **UN Regulation No. 79 (조향장치, 04 series Supplement 6)**, EU 관보 OJ L 2025/3 (2025.01.10) · http://data.europa.eu/eli/reg/2025/3/oj
  ...
  - §5.6.4.8.2 감지 영역 그림: 옆 차로를 따라 뒤로 뻗은 직사각형 / §5.6.4.8.1 후방 감지거리 S_rear ≥ 55 m / §5.1.6.3.9.17 감지 범위는 "바로 옆 차로로의 변경이 위험하지 않은지 판단하기에 충분"해야 함 → **폭 0.76 m(트랙 차로 1개) × 길이 5.1 m** (`scan_sectors.right_lane_zone`)
    - 길이: 55 m × 전장비 440/4,710 mm(아반떼 CN7 기준, ≈1/10.7) = 5.1 m
    - 폭: 트랙 차로폭 ≈ 차폭 380 mm × 2 = 0.76 m (실제 도로도 차로 3.5 m ≈ 아반떼 전폭 1,825 mm × 1.9로 비율이 같음)
