...
# 카메라/Hailo 인식은 이 launch가 아니라 safecar 패키지의 safecar.launch.py가 담당한다.
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # robot_state_publisher / joint_state_publisher(URDF→TF)는 뺐다(2026-09-21).
        # 시연 경로에서 TF를 쓰는 노드가 없고(RViz·내비게이션 미사용), Pi에서 GUI용
        # joint_state_publisher까지 불필요하게 돌고 있었다. 그래서 stella_description도 제거.
